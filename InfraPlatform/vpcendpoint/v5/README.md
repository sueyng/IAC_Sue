...
YAML is the primary parameter format for this template (self-documenting with `<edit_here>` placeholders and inline comments). The full file lives at `v5/Env/parameters-vpcendpoint.yaml`.
