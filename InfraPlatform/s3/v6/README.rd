...
Resources provisioned:
* Inspector Report S3 Bucket
* EC2 File Repository S3 Bucket
* S3 Bucket Policies with security controls
* Lambda Function for exporting Inspector finding report in CSV format to Inspector Report S3 Bucket
* EventBridge to schedule to execute Lambda Function
...
| InspectorSchedule | String | cron(0 8 ? * SUN#2 *) | cron(0 8 ? * SUN#2 *) | cron(0 8 ? * SUN#2 *) | Yes|
