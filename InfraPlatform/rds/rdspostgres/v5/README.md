...
14. **Network Configuration:**
    - Configure VPC CIDR ranges (VpcCidr1, VpcCidr2, VpcCidr3, VpcCidr4, VpcCidr5) for proper network access control. Up to 5 VPC CIDR ranges are supported for complex multi-VPC architectures.
    - Configure app subnet CIDR ranges (VPCSubnetCidrAppAZ1-6) to allow database access from application subnets.
