...
14. **Network Configuration:**
    ...
    - Set DBSubnetCidrAZ1/2/3 to allow database administration and monitoring tools access from database subnets.
    - Use AdditionalAppPrefixList for flexible access from additional application networks via prefix lists.

15. **Enhanced Security Group Configuration (v3.1):**
    - **Database Subnet Access**: Configure DB subnet CIDR ranges (DBSubnetCidrAZ1/2/3) for administrative access and monitoring tools.
    - **Additional Network Access**: Use AdditionalAppPrefixList parameter to allow access from additional application networks.
    - **Flexible Networking**: Supports both direct app subnet access and database subnet access patterns.
    - **Conditional Access**: DB subnet AZ3 and additional app networks are optional and conditionally configured.
