...
| ProdDBPort | *String* | Default: 53341 | Database port for production |
| NProdDBPort | *String* | Default: 53331 | Database port for non-production |
...
All resources are tagged with `IaCVersion: InfraPlatform-rdsproxy-v2`
