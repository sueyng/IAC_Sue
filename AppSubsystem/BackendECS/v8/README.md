# Backend ECS CloudFormation Templates - v8
...
2. If any bucket names violate the convention, either (a) rename the bucket to follow the convention, or (b) attach an additional inline policy via the service template.
...
- Comprehensive IAM policies for:
  ...
  - S3 (object operations, scoped to `${AppShortName}*`)
