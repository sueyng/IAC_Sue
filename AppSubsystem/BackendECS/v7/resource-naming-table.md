# AWS Resources Naming Convention - Backend ECS Template v6
...
## New in v7
### Configurable ALB TLS Security Policy
| Parameter | Description | Default |
|-----------|-------------|---------|
| `ALBSslPolicy` | ELB Security Policy for the HTTPS listener (TLS 1.2+ only) | `ELBSecurityPolicy-TLS13-1-2-2021-06` |

### Extended BCS Proxy CIDR and Port to add ECS Service Security Group
| Parameter | Description | Default |
|-----------|-------------|---------|
| `BCSProxyCidr` | BCS Proxy Subnet CIDR| "" |
| `BCSProxyPort` | BCS Proxy Port | "" |
...
| Parameter | Description | Default |
|-----------|-------------|---------|
| `VpcCidr4` | Quaternary VPC CIDR for additional network connectivity | "" |
| `VpcCidr5` | Quinary VPC CIDR for additional network connectivity | "" |

### Enhanced Network Security (v6)
- **Multi-VPC Support**: Security group rules now support up to 5 VPC CIDR ranges (previously 3)
- **Complex Topologies**: Better support for multi-VPC peering, hybrid cloud, and cross-region architectures
