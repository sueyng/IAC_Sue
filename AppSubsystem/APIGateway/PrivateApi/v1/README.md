...
This CloudFormation template deploys a private API Gateway infrastructure with Lambda authorizer integration, custom domain support, and Azure AD authentication. The system provides secure API access within a VPC using endpoint integration.
...
### 1. Lambda Authorizer Template (cf-lambda-authorizer.yaml)
Deploys:
...
### 2. Private API Gateway Template (cf-private-apigw.yaml)
Deploys:
- Private REST API
